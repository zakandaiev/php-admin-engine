<div class="header__item ml-2 dropdown dropdown_bottom-right">
	...
	<div class="dropdown__menu">
		<a href="<?= site('url_language') ?>/admin/profile" class="dropdown__item"><i class="icon icon-user"></i> <?= __('admin.navbar.profile') ?></a>
		<a href="<?= site('url_language') ?>/admin/profile/edit" class="dropdown__item"><i class="icon icon-settings"></i> <?= __('admin.navbar.settings') ?></a>
