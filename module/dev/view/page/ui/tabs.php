<?php Theme::template('ui-header', ['title' => 'Tabs']); ?>
...
<div class="mt-2">
  <div class="row cols-xs-1 cols-md-2 gap-xs">
    ...
    <div class="col">
      <div class="tab">
        <nav class="tab__nav tab__nav_icon">
          <a href="#tab-icon-1" class="tab__nav-item active"><i class="ti ti-home"></i></a>
          <a href="#tab-icon-2" class="tab__nav-item"><i class="ti ti-settings"></i></a>
          <a href="#tab-icon-3" class="tab__nav-item"><i class="ti ti-mail"></i></a>
        </nav>
    ...
    <div class="col">
      <div class="tab tab_vertical">
        <nav class="tab__nav tab__nav_icon">
          <a href="#tab-vertical-icon-1" class="tab__nav-item active"><i class="ti ti-home"></i></a>
          <a href="#tab-vertical-icon-2" class="tab__nav-item"><i class="ti ti-settings"></i></a>
          <a href="#tab-vertical-icon-3" class="tab__nav-item"><i class="ti ti-mail"></i></a>
        </nav>
